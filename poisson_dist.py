...
if __name__ == "__main__":
    ...
    ideal_mean = LAMBDA
    ideal_var = LAMBDA / const.SAMPLES

    draw.draw(x_bars, ideal_mean, ideal_var, graph_title="Distribution of Samples of Poisson Distribution with $\\lambda$ = " + str(LAMBDA))
